...
- API version: 1.0.0
  - Build date: 2025-06-28T00:39:26.208293+02:00[Europe/Oslo]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**createTransaction**](docs/DefaultApi.md#createTransaction) | **POST** /transactions | Create a new transaction
*DefaultApi* | [**getTransactionsByStatus**](docs/DefaultApi.md#getTransactionsByStatus) | **GET** /transactions/statuses/{status} | Get transactions by status
