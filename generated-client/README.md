...
- Build date: 2025-06-27T11:20:15.408010+02:00[Europe/Oslo]
...
import org.openapitools.client.dto.*;
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**transactionsStatusesStatusGet**](docs/DefaultApi.md#transactionsStatusesStatusGet) | **GET** /transactions/statuses/{status} | Get transactions by status
